...
// Constants
const int NUM_STEPPERS = 13; // one x axis and 8 z axis for RND
...
const int InputStartPin = NUM_STEPPERS*2 + OutputStartPin;
...
const int MS2Pin = A4;
const int MS3Pin = A5;
const int MS1Switch = A6;
const int MS2Switch = A7;
const int MS3Switch = A8;
...
void setup() {
  ...
  // Set the step size switches as input
  pinMode(MS1Switch, INPUT);
  pinMode(MS2Switch, INPUT);
  pinMode(MS3Switch, INPUT);
...
//add code for step size switches
